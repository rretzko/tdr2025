...
use App\Filament\Resources\Events\Versions\JudgeResource\Pages;
...
class JudgeResource extends Resource
{
    ...
    protected static ?string $slug = 'events/versions/judges';
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                ...
                TextInput::make('status_type')
                    ->required(),

                TextInput::make('judge_type')
                    ->required(),
            ]);
    }
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                TextColumn::make('status_type'),

                TextColumn::make('judge_type'),
            ])
            ->filters([
                //
            ])
