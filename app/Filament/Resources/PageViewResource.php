...
class PageViewResource extends Resource
{
    ...
    protected static ?string $slug = 'page-views';
        ...
        return $form
            ->schema([
                Placeholder::make('created_at')
                    ->label('Created Date')
                    ->content(fn(?PageView $record): string => $record?->created_at?->diffForHumans() ?? '-'),

                Placeholder::make('updated_at')
                    ->label('Last Modified Date')
                    ->content(fn(?PageView $record): string => $record?->updated_at?->diffForHumans() ?? '-'),
