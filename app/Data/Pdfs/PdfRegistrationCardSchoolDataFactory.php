...
class PdfRegistrationCardSchoolDataFactory
{
    private array $dto = [];
    private int $versionId = 0;

    public function __construct(private readonly Version $version, private readonly School $school)
    {
    ...
    private function getRows(): array
    {
        ...
        foreach ($candidates as $candidate) {
            ...
            $rows[] = [
                ...
                'ref' => $candidate->ref,
                'rooms' => $this->getRooms($candidate->voice_part_id),
    ...
    private function sql()
    {
        return DB::table('candidates')
            ...
            ->where('candidates.school_id', $this->school->id)
            ->select('candidates.ref', 'candidates.voice_part_id',
    ...
    private function getRooms(int $voicePartId): array
    {
