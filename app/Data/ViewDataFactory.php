...
//        }
    ...
    private function getLivewireComponent(): string
    {
        $components = [
            ...
            'library items' => 'libraries.items.item-table-component',
            'library item' => 'libraries.items.item-component',
            ...
            'tabroom summary report' => 'events.versions.tabrooms.tabroom-summary-report-component',
            'tabroom sandbox' => 'events.versions.tabrooms.tabroom-sandbox-component',
