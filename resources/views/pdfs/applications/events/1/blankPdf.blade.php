<div class="mt-4">
    ...
    <div class="flex flex-col text-center">
        ...
        @if($dto['onSiteRegistrationFee'])
            ...
            <div style="text-align: center; font-size: 0.66rem; font-weight: bold; color:lightgray;">
                ({{ $dto['versionId'] }}-####)
            </div>
        @endif
    ...
    <table class="summaryTbl" style="border-collapse: collapse; width: 99%; margin: auto; margin-bottom: 0.5rem;">
        <tbody>
        <tr>
            <td style="color: lightgray;">Student Name</td>
            <td style="color: lightgray;">Voice Part</td>
            <td style="color: lightgray;">Grade:</td>
            <td style="color: lightgray;">School Name</td>
        </tr>
        </tbody>
    </table>
    ...
    <table class="summaryTbl" style="border-collapse: collapse; width: 99%; margin: auto; margin-bottom: 0.5rem;">
        ...
        <tr>
            <td style="color: lightgray;">Home Phone</td>
            <td style="color: lightgray;">Student Cell</td>
            <td style="color: lightgray;">Parent Cell</td>
    ...
    <section id="studentEndorsement" style="margin-bottom: 1rem;">
        ...
        <div class="conditions">
            <div class="flex flex-col justify-self-stretch mx-4 mb-4" style="text-align: justify;">
                ...
                of my school's musical performing organization. I further understand that I must remain an active
                member of my school's performing group, in good standing, throughout my CJMEA Region II Choral
        ...
        <div class="conditions">
            <div class="flex flex-col justify-self-stretch mx-4 mb-4">
                <p class="mb-2" style="text-align: justify;">
                    As a parent or legal guardian of this student, I give permission for the student to be an applicant
                    for this organization. I understand that neither the school nor CJMEA assumes responsibility for
                    illness or accident. I further attest to the statement signed by the student and will assist the
                    student
                    in fulfilling the obligations incurred. I will encourage and assist the student in complying with
                    the
                    attendance policy as set forth in this document. I also give permission to CJMEA to use the
                ...
                <p class="mb-2" style="text-align: justify;">
                    ...
                    up
                    the student on or within twenty-minutes after posted rehearsal dismissal time.
                </p>
            </div>
    ...
    <section id="teacherEndorsement" style="margin-bottom: 1rem;">
        ...
        <div class="conditions">
            <div class="flex flex-col justify-self-stretch mx-4 mb-4" style="text-align: justify;">
                ...
                We, the undersigned, recommend the student for participation in this CJMEA sponsored activity.
                The student is a qualified candidate for this activity and is presently enrolled in an eligible grade
                at our school. We understand, in order to audition, that the student:
                <ol class="ml-8 list-decimal text-sm">
                    <li style="text-align: justify;">
                        is a member of the school's musical performing organization. By this we mean that a
                        student auditioning for chorus must be a member of the school choral program,
                        and a student auditioning for band or orchestra must be a member of the school
                ...
                <p class="my-2" style="text-align: justify;">
                    ...
                    performing
                    organization throughout the CJMEA Region II Chorus experience. We understand that the undersigned
                    teacher,
                    ...
                    the student is accepted into the group, we will use our influence to see that the student is
                    properly prepared and that the student adheres to the rules, regulations, and policies printed on
